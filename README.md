About jupyterlab-dyno-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jupyterlab-dyno-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jupyterlab-dyno-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jupyterlab-dyno
# for installing globally
pixi global install jupyterlab-dyno
```
...
It is possible to list all of the versions of `jupyterlab-dyno` available on your platform:
...
```
pixi search jupyterlab-dyno --channel conda-forge
```
